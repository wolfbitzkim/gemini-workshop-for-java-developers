...
public class ClaudeRestExample {
  public static void main(String[] args) throws IOException {
    ...
    Request request = new Request.Builder()
        .url(
            "https://us-east5-aiplatform.googleapis.com/v1/projects/pjt-dev-lgcaip-playground/locations/us-east5/publishers/anthropic/models/claude-opus-4@20250514:rawPredict")
